...
like PCs with two aspects and a full skill pyramid. NPCs who are intended to
challenge the group of PCs should have a larger skill pyramid than PCs, as
they're competing against the entire group.

Background characters show up once or twice an general serve a simple role in
the narrative. They can generally get away with a single aspect and a small
selection of skills. The bartender who makes small talk and drops a few rumors
doesn't need a full skill Pyramid, he probably just needs `Performance` or
`Persuasion`. Likewise, a set of guards keeping Tor Byron out of the royal
ball might only need an aspect like ~~Somewhat Loyal and Underpaid Guards~~
and the skills `Fight` and `Persuasion` in case Tor Byorn tries to force or
bribe his way in. If a background character suddenly becomes important to
story, you can give them more skills and aspects to reflect their newfound
narrative weight.
